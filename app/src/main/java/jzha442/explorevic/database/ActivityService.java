...
public class ActivityService {
    ...
    //get all different activities
    public ArrayList<String> getActivityNameList(){
        SQLiteDatabase db=dbHelper.getReadableDatabase();
        String selectQuery="SELECT DISTINCT "+Activity.KEY_name+" FROM "+Activity.TABLE+" ORDER BY "+Activity.KEY_name;
        ...
        if(cursor.moveToFirst()){
            do{
                String activity = cursor.getString(cursor.getColumnIndex(Activity.KEY_name));
