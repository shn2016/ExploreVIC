...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //--Create FavouritePlace table
        String CREATE_TABLE_FavouritePlace="CREATE TABLE "+ FavouritePlace.TABLE+"("
                +FavouritePlace.KEY_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "//AUTOINCREMENT
                +FavouritePlace.KEY_name+" TEXT, "
                +FavouritePlace.KEY_desc+" TEXT, "
                +FavouritePlace.KEY_region+" TEXT, "
                +FavouritePlace.KEY_address+" TEXT, "
                +FavouritePlace.KEY_latitude+" REAL, "
                +FavouritePlace.KEY_longitude+" REAL, "
                +FavouritePlace.KEY_activity+" TEXT, "
                +FavouritePlace.KEY_facility+" TEXT, "
                +FavouritePlace.KEY_pix+" BLOB, "
                +FavouritePlace.KEY_ap_id+" INTEGER, "
                +"FOREIGN KEY ("+FavouritePlace.KEY_ap_id+") REFERENCES "+ActivityPlace.TABLE+"("+ActivityPlace.KEY_ID+" ) "
                +")";
        db.execSQL(CREATE_TABLE_FavouritePlace);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+ FavouritePlace.TABLE);
