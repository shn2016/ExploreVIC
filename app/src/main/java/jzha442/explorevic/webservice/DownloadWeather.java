...
public class DownloadWeather{
    ...
    private static final String OPEN_WEATHER_MAP_API = "b07ca495d55e7ac78121f73c62598121";//eb881196ab5b6a8cbbcbe567b2b0580c  //e08537b1f13f3f07ed4a9535e3e531eb //b07ca495d55e7ac78121f73c62598121
    ...
    public static ArrayList<Weather> transferJsonToWeather(JSONObject json){
        ...
        try {
            ...
            for(int i=0;i<5; i++) {
                ...
                String tempMin = String.format("%.0f",timeTransfer(dailyWeather.getDouble("temperatureMin")))+"°C";
                String tempMax = String.format("%.0f",timeTransfer(dailyWeather.getDouble("temperatureMax")))+"°C";
